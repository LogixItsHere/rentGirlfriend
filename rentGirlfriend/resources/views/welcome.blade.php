...
<body class="antialiased">
    <div class="relative flex items-top bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
        <div class="fixed ms-1">
            <a class="text-dark">HoneyDesk</a>
        </div>
        @if (Route::has('login'))
    ...
    {{-- <div class="">
        <img src="{{ asset('background/bannner.jpg') }}" class="rounded mx-auto d-block" />
    </div> --}}
            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="features-icons-item mx-auto mb-5 mb-lg-3">
                        ...
                        <h3>If wanting to find a friend to go shopping</h3>
                        <p class="lead mb-0">We can be for you</p>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="features-icons-item mx-auto mb-5 mb-lg-3">
                        ...
                        <h3>If you want to find friends to play games</h3>
                        <p class="lead mb-0">We can be for you!</p>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="features-icons-item mx-auto mb-5 mb-lg-3">
                        ...
                        <h3>If you want to find someone to heal your heart</h3>
                        <p class="lead mb-0">We can be for you!!</p>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row d-flex">
                        <div class="col-12 col-md-12 mb-2 mb-md-0">
                            @if (Route::has('login'))
                                ...
                                @else
                                    @if (Route::has('register'))
                                        <a href="{{ route('register') }}" class="btn btn-outline-success btn-rounded"
                                            style="width: 250px;
                                                    height: 60px;
                                                    padding-top: 15px;">Click
                                            To Register </a>
                                    @endif
                                @endauth
                        </div>
